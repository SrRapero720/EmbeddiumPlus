...
public class FastBlocks {
    // REPOSITORY IDS FABRIC ASSIGNS TO THE BUILT-IN PACKS (THE ResourceLocation#toString OF EACH)
    ...
    // REGISTER THE resourcepacks/solid_beds AND resourcepacks/solid_chests PACKS AS TOGGLEABLE BUILT-INS AT INIT
    public static void registerPacks() {
        ...
        ResourceManagerHelper.registerBuiltinResourcePack(ResourceLocation.fromNamespaceAndPath(Chloride.ID, "solid_beds"),
                mod, Component.literal("Chloride: Solid Beds"), ResourcePackActivationType.NORMAL);
        ResourceManagerHelper.registerBuiltinResourcePack(ResourceLocation.fromNamespaceAndPath(Chloride.ID, "solid_chests"),
